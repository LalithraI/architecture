...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Using FormSubmit - No API key needed, works immediately
      ...
      const response = await fetch('https://formsubmit.co/lalithraindupa2002@gmail.com', {
        method: 'POST',
        body: formDataToSend,
        headers: {
    ...
    <section className="contact" id="contact">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">Let's discuss your next architectural project</p>
        </div>
        ...
        <div className="contact-wrapper">
          <div className="contact-info">
            <div className="info-card">
              ...
              <h3>Location</h3>
              <p>No 12, Watareka<br/>Galle, Sri Lanka</p>
            </div>
            ...
            <div className="info-card">
              ...
              <h3>Email</h3>
              <p>lalithraindupa2002@gmail.com<br/>Chamoda Dewnith</p>
            </div>
            ...
            <div className="info-card">
              ...
              <h3>Phone</h3>
              <p>+94 721146960<br/>Chamoda Dewnith</p>
            </div>
